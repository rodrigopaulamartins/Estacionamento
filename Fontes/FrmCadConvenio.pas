...
begin
   ...
   begin
      ...
      begin
         Application.MessageBox('Informe o tipo de desconto.','ATENÇÃO', MB_ICONEXCLAMATION+MB_OK);
      ...
      begin
         ...
         begin
            Application.MessageBox('Informe o valor do convênio.','ATENÇÃO', MB_ICONEXCLAMATION+MB_OK);
