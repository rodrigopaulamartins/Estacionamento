...
begin
   ...
   begin
      ...
      Writeln(Arquivo,I137car+'   '+'Valor da Saída: ' + FormatFloat('###,###,#0.00',vlrsangria));
      WriteLn(Arquivo,IPula);
      WriteLn(Arquivo,IPula);
      WriteLn(Arquivo,IPula);
   ...
   lbl4.Caption    := '0';
   Label2.Caption  := '0';
   Application.MessageBox('Caixa fechado com sucesso!!!','CONFIRMAÇÃO', MB_ICONINFORMATION+MB_OK);
