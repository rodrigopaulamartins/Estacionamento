...
begin
   ...
   begin
      Application.MessageBox('Quantidade superior ao permitido, verifique.','ATENÇÃO', MB_ICONSTOP+MB_OK);
      Abort;
   end;
end;
...
begin
   ...
   begin
      Application.MessageBox('Nenhum registro selecionado.','ATENÇÃO', MB_ICONEXCLAMATION+MB_OK);
      Abort;
   end;
   //faz a exlcusão caso necessaro
   if Application.MessageBox('Tem certeza que deseja excluir o registro?','ATENÇÃO', MB_ICONQUESTION+MB_YESNO)=IDYES then
   begin
